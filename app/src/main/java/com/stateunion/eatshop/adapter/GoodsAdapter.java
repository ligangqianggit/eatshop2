    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewholder.iv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int count = ((DingCanActivity)context).getSelectedItemCountById(list.get(position).getProduct_id());
                ...
                ((DingCanActivity)context).handlerCarNum(1,list.get(position),true);
                catograyAdapter.notifyDataSetChanged();
                ...
                ((DingCanActivity)context).setAnim(ball, startLocation);// 开始执行动画
        ...
        viewholder.iv_remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((DingCanActivity)context).handlerCarNum(0,list.get(position),true);
                catograyAdapter.notifyDataSetChanged();
