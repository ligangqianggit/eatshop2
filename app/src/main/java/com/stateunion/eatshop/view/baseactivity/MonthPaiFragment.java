...
public class MonthPaiFragment extends BaseFragment implements IBaseDialogView {
    private ListView list_paimingtwo;
    private boolean isAlin = false;
    @Override
    public int getLayoutId() {
        return R.layout.fragment_monthpai;
    }
    ...
    public void getPaiming(){
        RequestCommand.getPaiming(new PaiMingCallBack(MonthPaiFragment.this),"1");
    ...
    public class PaiMingCallBack extends DialogCallback<PaiMingBean,MonthPaiFragment> {
        PaiMingListAdapter paiMingListAdapter;
        public PaiMingCallBack(MonthPaiFragment requestView) {
            super(requestView);
        }
        @Override
