...
public class WeekPaiFragment extends BaseFragment implements IBaseDialogView {
    private ListView list_paimingtwo;
    private boolean isAlin = false;
    @Override
    public int getLayoutId() {
        return R.layout.fragment_weekpai;
    }
    ...
    public void getPaiming(){
        RequestCommand.getPaiming(new PaiMingCallBack(WeekPaiFragment.this),"1");
    ...
    public class PaiMingCallBack extends DialogCallback<PaiMingBean,WeekPaiFragment> {
        PaiMingListAdapter paiMingListAdapter;
        public PaiMingCallBack(WeekPaiFragment requestView) {
            super(requestView);
        }
        @Override
