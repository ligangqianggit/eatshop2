...
public class LunthFragment extends Fragment implements IBaseDialogView {
    ...
    public void call2(){
        RequestCommand.getTongji(new TongJICallBack1(LunthFragment.this), "全部");
    }
    ...
    public class TongJICallBack extends DialogCallback<TongJiBean, LunthFragment> {
        ShengRiListAdapter shengRiListAdapter;

        public TongJICallBack(LunthFragment requestView) {
            super(requestView);
        }
    ...
    public class TongJICallBack1 extends DialogCallback<TongJiBean, LunthFragment> {
        public TongJICallBack1(LunthFragment requestView) {
            super(requestView);
        }
        @Override
        protected void onResponseSuccess(TongJiBean tongJiBean, Call<TongJiBean> call) {
