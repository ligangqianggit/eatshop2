...
public class OverTimeFragment extends Fragment implements IBaseDialogView {
    ...
    public class TongJICallBackW extends DialogCallback<TongJiBean, OverTimeFragment> {
        ShengRiListAdapter shengRiListAdapter;

        public TongJICallBackW(OverTimeFragment requestView) {
            super(requestView);
        }
